      ...
      <div className="space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Select onValueChange={(value) => handleChange("primarySkill", value)}>
              <SelectTrigger className="h-12 rounded-xl">
                <SelectValue placeholder="Your Primary Skill" />
              </SelectTrigger>
              <SelectContent>
                {skills.map((skill) => (
            ...
            <Select onValueChange={(value) => handleChange("wantToLearn", value)}>
              <SelectTrigger className="h-12 rounded-xl">
                <SelectValue placeholder="Want to Learn" />
              </SelectTrigger>
              <SelectContent>
                {skills.map((skill) => (
                  <SelectItem key={skill} value={skill}>
