...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
                ...
                {open && (
                  <div className="absolute right-0 mt-2 w-40 bg-card border border-border rounded-xl shadow-lg p-2">
                    ...
                    <button
                      ...
                      className="w-full text-left px-3 py-2 text-sm hover:bg-muted rounded-md text-red-500"
                    >
                      Logout
                    </button>
                  </div>
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 px-4 relative overflow-hidden bg-dark text-light">
        {/* Background decorations */}
        <div className="absolute top-20 left-1/4 w-96 h-96 bg-primary/5 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-accent/5 rounded-full blur-3xl" />

        <div className="container mx-auto text-center relative z-10 text-light">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 animate-fade-in text-light">
            Exchange Skills.{" "}
            <span className="gradient-text">Grow Together.</span>
          </h1>

          <p className="text-lg max-w-2xl mx-auto mb-8 animate-fade-in text-muted-foreground">
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="max-w-xl mx-auto text-muted-foreground">
              A new way to learn and teach, powered by community and mutual
              growth.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              ...
              >
                <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform bg-primary/20">
                  <feature.icon size={24} style={{ color: "#38bdf8" }} />
                </div>
                <h3 className="font-semibold mb-2 text-light">
                  {feature.title}
                </h3>
      ...
      <section className="py-20 px-4 bg-dark text-light">
        <div className="container mx-auto text-center">
          ...
          <p className="max-w-2xl mx-auto text-muted-foreground mb-6">
            SkillSwap is a global community where people exchange knowledge and
            skills for free. Our mission is to make learning accessible, fun,
      ...
      <section className="py-20 px-4 bg-dark text-light">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4 text-light">How It Works</h2>
      ...
      <section className="py-20 px-4 bg-dark text-light">
        <div className="container mx-auto text-center">
          ...
          <p className="max-w-2xl mx-auto text-muted-foreground mb-6">
            Read how SkillSwap has helped thousands of people learn new skills,
            make friends, and grow their careers.
          </p>
          <div className="grid md:grid-cols-3 gap-8 mt-8">
            <div className="bg-card rounded-xl p-6 shadow-card border border-border">
              <span className="text-4xl">🎨</span>
              <p className="mt-2">
                Sarah learned React in exchange for teaching UI design. "Best
            ...
            <div className="bg-card rounded-xl p-6 shadow-card border border-border">
              <span className="text-4xl">💻</span>
              <p className="mt-2">
                Michael picked up photography skills while teaching Python.
                "Win-win!"
              </p>
            </div>
            <div className="bg-card rounded-xl p-6 shadow-card border border-border">
              <span className="text-4xl">📸</span>
              <p className="mt-2">
                Emma made friends and learned new skills. "The community here is
                amazing."
              </p>
            </div>
          </div>
      ...
      <section className="py-20 px-4 bg-dark text-light">
        <div className="container mx-auto text-center">
          ...
          <div className="max-w-2xl mx-auto text-left text-muted-foreground">
            <p className="mb-2">
              <strong>Is SkillSwap free?</strong> Yes, it's 100% free to join
              and use.
            </p>
            <p className="mb-2">
              <strong>How do I find a skill partner?</strong> Our smart matching
              algorithm helps you connect instantly.
            </p>
            <p className="mb-2">
              <strong>Can I teach and learn at the same time?</strong>{" "}
              Absolutely! Many members do both.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-dark text-light">
        <div className="container mx-auto text-center">
          ...
          <p className="max-w-2xl mx-auto text-muted-foreground mb-6">
            Ready to start your learning journey? Connect with thousands of
      ...
      <section className="py-20 px-4 bg-dark text-light">
        <div className="container mx-auto">
          <div className="gradient-bg rounded-3xl p-12 text-center text-primary-foreground relative overflow-hidden bg-[#23262f]">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-light">
                Ready to Start Swapping?
              </h2>
              <p className="text-primary-foreground/80 mb-8 max-w-xl mx-auto text-muted-foreground">
                Join thousands of learners and teachers exchanging skills every
                day.
              </p>
              <Link href="/signup">
      ...
      {/* Footer */}
      <footer className="py-8 px-4 border-t border-border bg-dark text-light">
