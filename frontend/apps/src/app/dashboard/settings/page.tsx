...
export default function Settings() {
  type NotificationKey = 'messages' | 'requests' | 'updates' | 'newsletter';
  type PrivacyKey = 'profilePublic' | 'showEmail' | 'allowMessages' | 'searchable';
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 rounded-lg border border-border hover:bg-secondary/50 transition-colors">
                    ...
                    <Switch
                      ...
                      onCheckedChange={() =>
                        handleNotificationChange("requests")
                      }
                    />
                  </div>
                  <div className="flex items-center justify-between p-4 rounded-lg border border-border hover:bg-secondary/50 transition-colors">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 rounded-lg border border-border hover:bg-secondary/50 transition-colors">
                    ...
                    <Switch
                      ...
                      onCheckedChange={() =>
                        handlePrivacyChange("profilePublic")
                      }
                    />
                  </div>
                  <div className="flex items-center justify-between p-4 rounded-lg border border-border hover:bg-secondary/50 transition-colors">
              ...
              <Card className="p-6 border border-border">
                ...
                <div className="space-y-4">
                  <div className="p-4 rounded-lg border border-border">
                    <Label className="text-base font-medium text-foreground block mb-3">
                      Change Password
                    </Label>
                  ...
                  <div className="p-4 rounded-lg border border-destructive/20 bg-destructive/5">
                    <Label className="text-base font-medium text-destructive block mb-2">
                      Danger Zone
                    </Label>
                    ...
                    <div className="flex gap-2 flex-col md:flex-row">
                      ...
                      <button
                        className="px-4 py-2 rounded-lg border border-border hover:bg-secondary transition-colors flex items-center justify-center gap-2 font-medium"
